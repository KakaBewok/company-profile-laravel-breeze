    ...
    <div id="Contact"
        ...
        <div class="flex flex-col mt-20 gap-[50px]">
            <div class="breadcrumb flex items-center gap-[30px]">
                <p class="text-cp-light-grey last-of-type:text-cp-black last-of-type:font-semibold"><a
            ...
            <div class="flex flex-col gap-5">
                <div class="flex items-center gap-[10px]">
                    ...
                    <p class="font-semibold text-cp-dark-blue">Bogor Regency, West Java</p>
                </div>
                <div class="flex items-center gap-[10px]">
                    <div class="flex w-6 h-6 shrink-0">
                        <img src="assets/icons/call.svg" alt="icon">
                    </div>
                    <p class="font-semibold text-cp-dark-blue">08515649xxxx</p>
                </div>
                <div class="flex items-center gap-[10px]">
                    <div class="flex w-6 h-6 shrink-0">
                        <img src="assets/icons/monitor-mobbile.svg" alt="icon">
                    </div>
                    <p class="font-semibold text-cp-dark-blue">noprizal.com</p>
                </div>
            </div>
        </div>
                ...
                <div class="flex flex-col w-full gap-2">
                    ...
                    <div
                        ...
                        <input type="text" name="name" id="name"
                            ...
                            placeholder="Zayn Malik" required>
                    </div>
                </div>
                <div class="flex flex-col w-full gap-2">
                    ...
                    <div
                        ...
                        <input type="email" name="email" id="email"
                            class="w-full font-semibold bg-white outline-none appearance-none placeholder:font-normal placeholder:text-cp-black"
                            placeholder="zayn.malik@gmail.com" required>
                    </div>
                </div>
            </div>
            <div class="flex items-center gap-[18px]">
                <div class="flex flex-col w-full gap-2">
                    ...
                    <div
                        ...
                        <input type="tel" name="phone_number" id="phone_number"
                            class="w-full font-semibold bg-white outline-none appearance-none placeholder:font-normal placeholder:text-cp-black"
                            placeholder="081266763338" required>
                    </div>
                </div>
                <div class="flex flex-col w-full gap-2">
                    ...
                    <div
                        ...
                        <button type="button" id="dateButton"
                            class="w-full p-0 text-left bg-transparent border-none outline-none">Choose the date</button>
            ...
            <div class="flex flex-col w-full gap-2">
                ...
                <div
                    ...
                    <textarea name="brief" id="brief" rows="6"
                        ...
                        placeholder=" The building will serve as the central hub for the company's operations, housing offices, meeting rooms, innovation labs, and collaborative spaces designed to foster creativity and productivity."></textarea>
                </div>
            </div>
            <button type="submit"
