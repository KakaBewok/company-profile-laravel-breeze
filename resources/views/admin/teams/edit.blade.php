                ...
                <form method="POST" action="{{ route('admin.teams.update', $team) }}" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <x-text-input id="name" class="block w-full mt-1" type="text" name="name" required
                            autofocus autocomplete="name" value="{{ $team->name }}" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="occupation" class="block w-full mt-1" type="text" name="occupation"
                            required autofocus autocomplete="occupation" value="{{ $team->occupation }}" />
                        <x-input-error :messages="$errors->get('occupation')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="location" :value="__('location')" />
                        <x-text-input id="location" class="block w-full mt-1" type="text" name="location" required
                            autofocus autocomplete="location" value="{{ $team->location }}" />
