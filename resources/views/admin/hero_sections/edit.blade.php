            ...
            <div class="p-10 overflow-hidden bg-white shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.hero_sections.update', $heroSection) }}"
                    ...
                    <div>
                        ...
                        <x-text-input id="heading" class="block w-full mt-1" type="text" name="heading" required
                            autofocus autocomplete="heading" value="{{ $heroSection->heading }}" />
                        <x-input-error :messages="$errors->get('heading')" class="mt-2" />
                    </div>

                    <div class="mt-4">
                        <x-input-label for="banner" :value="__('banner')" />
                        <img src="{{ Storage::url($heroSection->banner) }}" alt="banner"
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="subheading" class="block w-full mt-1" type="text" name="subheading"
                            required autofocus autocomplete="subheading" value="{{ $heroSection->subheading }}" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="achievement" class="block w-full mt-1" type="text" name="achievement"
                            required autofocus autocomplete="achievement" value="{{ $heroSection->achievement }}" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="path_video" class="block w-full mt-1" type="text" name="path_video"
                            required autofocus autocomplete="path_video" value="{{ $heroSection->path_video }}" />
